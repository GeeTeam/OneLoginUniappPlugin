...
-keep class com.geetest.onelogin.OneLoginManager{*;}
-keep class com.geetest.onelogin.OneLoginManager$*{*;}
...
-ignorewarnings
#-libraryjars libs/quick_login_android_5.7.1.jar
#-libraryjars libs/uniaccount_base_4.0.0AR02B0901.jar
#-libraryjars libs/CTAccount_sdk_api_v3.7.0_all.jar